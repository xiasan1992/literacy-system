...
const famousQuotes = {
    ...
    '心': [{q:'人生自古谁无死，留取丹心照汗青',s:'过零丁洋',a:'文天祥'},{q:'心远地自偏',s:'饮酒',a:'陶渊明'}],
    '目': [{q:'欲穷千里目',s:'登鹳雀楼',a:'王之涣'}],
    '耳': [{q:'隔篁竹，闻水声，如鸣佩环，心乐之',s:'小石潭记',a:'柳宗元'}],
    '头': [{q:'低头思故乡',s:'静夜思',a:'李白'}],
    // 时令与景物
    '春': [{q:'春眠不觉晓',s:'春晓',a:'孟浩然'},{q:'春风又绿江南岸',s:'泊船瓜洲',a:'王安石'},{q:'春色满园关不住',s:'游园不值',a:'叶绍翁'}],
    '秋': [{q:'自古逢秋悲寂寥',s:'秋词',a:'刘禹锡'},{q:'落霞与孤鹜齐飞，秋水共长天一色',s:'滕王阁序',a:'王勃'}],
    '雪': [{q:'孤舟蓑笠翁，独钓寒江雪',s:'江雪',a:'柳宗元'},{q:'窗含西岭千秋雪',s:'绝句',a:'杜甫'}],
    ...
    '青': [{q:'客从远方来，遗我双鲤鱼…中有尺素书',s:'饮马长城窟行',a:'汉乐府'},{q:'青山遮不住',s:'菩萨蛮',a:'辛弃疾'}],
    ...
    '远': [{q:'非淡泊无以明志，非宁静无以致远',s:'诫子书',a:'诸葛亮'}],
    '光': [{q:'水光潋滟晴方好',s:'饮湖上初晴后雨',a:'苏轼'}],
    '声': [{q:'夜来风雨声',s:'春晓',a:'孟浩然'},{q:'不见人，但闻人语响',s:'鹿柴',a:'王维'}],
    '夜': [{q:'夜来风雨声',s:'春晓',a:'孟浩然'},{q:'夜阑卧听风吹雨',s:'十一月四日风雨大作',a:'陆游'}],
    '梦': [{q:'夜阑卧听风吹雨，铁马冰河入梦来',s:'十一月四日风雨大作',a:'陆游'}],
    '行': [{q:'长风破浪会有时，直挂云帆济沧海',s:'行路难',a:'李白'}],
    '思': [{q:'举头望明月，低头思故乡',s:'静夜思',a:'李白'}],
    '故': [{q:'举头望明月，低头思故乡',s:'静夜思',a:'李白'},{q:'故人西辞黄鹤楼',s:'黄鹤楼送孟浩然之广陵',a:'李白'}],
    '乡': [{q:'低头思故乡',s:'静夜思',a:'李白'}],
    '书': [{q:'书中自有黄金屋',s:'劝学诗',a:'赵恒'}],
    '剑': [{q:'剑外忽传收蓟北',s:'闻官军收河南河北',a:'杜甫'}],
    '酒': [{q:'劝君更尽一杯酒',s:'送元二使安西',a:'王维'},{q:'酒入愁肠化作相思泪',s:'苏幕遮',a:'范仲淹'}],
    '舟': [{q:'孤舟蓑笠翁',s:'江雪',a:'柳宗元'}],
    '楼': [{q:'欲穷千里目，更上一层楼',s:'登鹳雀楼',a:'王之涣'},{q:'故人西辞黄鹤楼',s:'黄鹤楼送孟浩然之广陵',a:'李白'}],
    '江': [{q:'孤帆远影碧空尽，唯见长江天际流',s:'黄鹤楼送孟浩然之广陵',a:'李白'},{q:'春风又绿江南岸',s:'泊船瓜洲',a:'王安石'}],
    '河': [{q:'黄河入海流',s:'登鹳雀楼',a:'王之涣'}],
    '海': [{q:'海上生明月',s:'望月怀远',a:'张九龄'}],
    '林': [{q:'停车坐爱枫林晚',s:'山行',a:'杜牧'}],
    '木': [{q:'落木千山天远大',s:'登快阁',a:'黄庭坚'}],
    '草': [{q:'离离原上草',s:'赋得古原草送别',a:'白居易'}],
    '树': [{q:'树木丛生，百草丰茂',s:'观沧海',a:'曹操'}],
    '春': [{q:'春风又绿江南岸',s:'泊船瓜洲',a:'王安石'}],
    '叶': [{q:'停车坐爱枫林晚，霜叶红于二月花',s:'山行',a:'杜牧'}],
    '霜': [{q:'霜叶红于二月花',s:'山行',a:'杜牧'}],
    '云': [{q:'不畏浮云遮望眼',s:'登飞来峰',a:'王安石'}],
    '星': [{q:'星垂平野阔',s:'旅夜书怀',a:'杜甫'}],
    '光': [{q:'床前明月光',s:'静夜思',a:'李白'}],
};
...
function showCharQuote(char, isReview) {
    ...
    if (!quoteEl) return;
    const quotes = famousQuotes[char];
    if (!quotes || quotes.length === 0) {
        quoteEl.classList.add('hidden');
        quoteEl.innerHTML = '';
        return;
    }
    // 随机选一句（每次翻到该字可能不同，增加趣味）
